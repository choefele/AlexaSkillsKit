...
- Open the generated Xcode project, select the Server scheme and run the profuct (CMD-R). This will start a server at port 8090 which you can test with `curl localhost:8090 --data-binary "@../Tests/AlexaSkillsKitTests/launch_request.json"`
